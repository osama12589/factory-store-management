                ...
                <div className="px-4 pb-3 flex justify-end gap-2 border-t border-gray-100 pt-2">
                  {editingId === item._id ? (
                    <>
                      ...
                      <button
                        onClick={cancelEdit}
                        className="p-2.5 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400"
                      >
                        <FaTimes size={16} />
                      </button>
                    </>
                    ...
                    <>
                      <button
                        ...
                        className="p-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition opacity-0 group-hover:opacity-100"
                      >
                        <FaEdit size={16} />
                      </button>
                      ...
                      <button
                        onClick={() =>
                          openDeleteModal(item._id, item.name)
                        }
                        className="p-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition opacity-0 group-hover:opacity-100"
                      >
                        <FaTrash size={16} />
                      </button>
                    </>
